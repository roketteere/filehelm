...
>(({ className, inset, destructive, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && "pl-8",
      destructive
        && "text-destructive-foreground focus:bg-destructive focus:text-destructive-foreground",
      className,
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1 text-[10px] font-medium uppercase tracking-widest text-muted-foreground",
      inset && "pl-8",
      className,
    )}
    {...props}
...
const ContextMenuShortcut = ({
  ...
  <span
    className={cn(
      "ml-auto rounded bg-muted px-1.5 py-0.5 font-mono text-[9px] text-muted-foreground",
      className,
    )}
    {...props}
  />
