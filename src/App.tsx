  ...
  return (
    <header className="flex h-12 items-center justify-between border-b border-border bg-card/70 px-4 backdrop-blur">
      <div className="flex items-center gap-2.5">
        <span className="grid h-7 w-7 place-items-center rounded-md bg-gradient-to-br from-helm-400 to-helm-700 text-background shadow-[0_0_24px_-4px_hsl(var(--ring)/0.5)]">
  ...
  return (
    <div className="grid h-full place-items-center p-8">
      <div className="max-w-md text-center">
        <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-xl bg-gradient-to-br from-helm-500 to-helm-800 shadow-[0_0_40px_-8px_hsl(var(--ring)/0.5)]">
          <Anchor className="h-7 w-7 text-background" />
        </div>
